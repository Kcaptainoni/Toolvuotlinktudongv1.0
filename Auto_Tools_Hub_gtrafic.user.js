// ==UserScript==
// @name         Auto Tools Hub — gtrafic
// @namespace    http://tampermonkey.net/
// @version      6.90-gtrafic
// @description  gtrafic tối ưu: domain sạch (không google.com), trade-btn, form link4m
// @author       You
// @match        *://*/*
// @grant        GM_setValue
// @grant        GM_getValue
...
// @all_frames   true
// @downloadURL  https://raw.githubusercontent.com/USER/REPO/main/Auto_Tools_Hub_gtrafic.user.js
// @updateURL    https://raw.githubusercontent.com/USER/REPO/main/Auto_Tools_Hub_gtrafic.user.js
// ==/UserScript==
...
(function () {
    ...
    function normalizeDomainHint(domain) {
        ...
        try {
            ...
            else if (domain.includes('/') && domain.includes('.')) domain = domain.split('/')[0];
        } catch (e) {}
    ...
    function scrapeKeywordDomainFromPage() {
        ...
        try {
            ...
            const tryEl = (el) => {
                ...
                if (el.closest && el.closest('#as-panel, #as-btn, #trade-btn-clf, svg')) return;
