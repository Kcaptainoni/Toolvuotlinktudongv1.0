// ==UserScript==
// @name         Auto Tools Hub (link4m) - Wait 3s
// @namespace    http://tampermonkey.net/
// @version      6.39
// @description  link4m - auto dán mã KM + tab Config + tìm Google tab mới + hết spam cuộn
// @author       You
// @match        *://*/*
// @grant        GM_setValue
// @grant        GM_getValue
    ...
    function ensureUI() {
        ...
        if (!document.getElementById('as-style')) {
            ...
            style.textContent = `
                ...
                .as-btn-orange { background: #ea580c !important; }
                .back-btn {
        ...
        document.getElementById('btn-magma').onclick = () => {
            alert('magma — đang update 🚧');
        };
